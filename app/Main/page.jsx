...
// const Page = () => {
//   return (
//     <div className="font-serif text-black bg-white h-screen w-full overflow-hidden relative">
...
//         <motion.div
//           className="bg-white  lg:relative lg:bottom-[255%] lg:w-[30%] lg:ml-24 lg:h-[50%] lg:space-y-5"
//           initial={{ opacity: 0 }}
//           animate={{ opacity: 1 }}
...
//         <motion.div
//           className="lg:relative lg:block hidden lg:bottom-[245%] border lg:w-[25%] lg:h-24 lg:ml-20 bg-gray-100 rounded-xl"
//           initial={{ opacity: 0 }}
//           animate={{ opacity: 1 }}
...
//         </motion.div>
//         <motion.div
//           className="lg:relative lg:block hidden lg:bottom-[257%] border lg:w-[25%] lg:h-24 lg:ml-[35%] bg-gray-100 rounded-xl"
//           initial={{ opacity: 0 }}
//           animate={{ opacity: 1 }}
...
//         </motion.div>
//         <motion.div
//           className="lg:relative lg:block hidden lg:bottom-[269%] lg:border lg:w-[25%] lg:h-24 lg:ml-[65%] bg-gray-100 rounded-xl"
//           initial={{ opacity: 0 }}
//           animate={{ opacity: 1 }}
