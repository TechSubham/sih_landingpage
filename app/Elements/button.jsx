    ...
    <div>
      <div class="group relative flex justify-center items-center text-zinc-600 text-sm font-bold">
        <div class="absolute opacity-0 group-hover:opacity-100 group-hover:-translate-y-[150%] -translate-y-[300%] duration-500 group-hover:delay-500 skew-y-[20deg] group-hover:skew-y-0 shadow-md">
          <div class="shadow-md bg-blue-600 absolute bottom-0 translate-y-1/2 left-1/2 translate-x-full rotate-45 p-1"></div>
        ...
        <div class="shadow-md flex items-center group-hover:gap-2 bg-gradient-to-br from-blue-600 to-blue-600 p-3 rounded-full cursor-pointer duration-300">
          <svg
            fill="none"
            viewBox="0 0 24 24"
            height="20px"
          ...
          <span class="text-[0px] group-hover:text-sm duration-300 text-white">
            Get Started
          </span>
        </div>
      </div>
